...
async function main() {
  await mongoose.connect('mongodb+srv://TRY_OWN:2005@cluster0.6hhoa.mongodb.net/test?retryWrites=true&w=majority&appName=Cluster0'); // Local MongoDB URL
}
...
const store = MongoStore.create({
    mongoUrl: 'mongodb+srv://TRY_OWN:2005@cluster0.6hhoa.mongodb.net/test?retryWrites=true&w=majority&appName=Cluster0', // Local MongoDB URL
    crypto: {
